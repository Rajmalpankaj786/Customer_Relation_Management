...
public class ServiceProviderChangePassword {

	public void ServiceProviderChangePassword() {
		...
		if(m.matches()) {
			...
			try {
				String res = dao.changeServiceProviderPassword(username, oldPassword, newPassword);
